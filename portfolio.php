...
<html id = "portfolio">
  ...
  <head>
    <title>Taylor Dodge | Portfolio</title>
...
<link rel="apple-touch-icon" sizes="57x57" href="apple-icon-57x57.png">
  ...
  <body>
	...
	<p id = "text">This is where Taylor's portfolio text will go. It's not here yet!</p>
	<br>
	<p id = "text">Lorem ipsum dolor sit amet, hinc rebum te duo, mel tritani denique id. Quodsi perpetua maluisset sea id. Sint detracto fabellas per in, sit sint utamur cu. Quem consul et vel, an nam eros summo munere. Et mei illud legendos, vis at cetero impetus inermis. Te qui etiam consequuntur.</p>
	<br>
	<p id = "text">Dicat liber causae ad has, vidit dolorum periculis ex nec, porro mediocrem sea ad. Ius saepe molestie forensibus eu, ne est numquam forensibus theophrastus. Eam ut viris soluta suavitate. Pri iudico scaevola et, qualisque reprehendunt vel in. At falli lobortis posidonium nam, eligendi pertinacia eam in.</p>
	</div>
