...
<link rel="apple-touch-icon" sizes="57x57" href="apple-icon-57x57.png">
  ...
  <body>
	...
	<h1 style = "width: 100%; margin: auto; text-align: center;">Map</h1>
	<div style = "width: 100%; margin: auto; text-align: center;padding-top: 10%;">
		<p = "text"><a href = "index.php">Home</a></p>
		<p = "text"><a href = "about.php">About</a></p>
		<p = "text"><a href = "blog.php">Blog</a></p>
		<p = "text"><a href = "research.php">Research</a></p>
		<p = "text"><a href = "portfolio.php">Portfolio</a></p>
		<p = "text"><a href = "learn.php">Learn</a></p>
		<p = "text"><a href = "contact.php">Contact</a></p>
		<p = "text"><a href = "cookies.php">Cookies</a></p>
		<p = "text"><a href = "terms.php">Terms and Conditions</a></p>
		<p = "text"><a href = "map.php">Site Map</a></p>
		<p = "text"><a href = "login.php">Log in</a></p>
	</div>
