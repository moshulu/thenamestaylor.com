<?php
	...
	***/
	...
	for($x = 0; $x<$count; $x++){
		...
		/*
		//THIS WORKS!
		$query = "SELECT * FROM `taylor_images` WHERE 1";
		...
		$insertQuery = "INSERT INTO `taylor_images`(`image_id`, `image_path`, `image_name`) VALUES ($id,'$path','$name')";
